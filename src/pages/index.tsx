  ...
  return (
    <div className="flex h-screen text-gray-100">
      <div className="p-r-6 space-y-3 overflow-y-auto bg-gray-900 p-3 scrollbar scrollbar-none">
        <div className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-3xl bg-gray-700 font-medium text-gray-100 transition-all duration-300 hover:rounded-2xl hover:bg-brand hover:text-white">
